  ...
  <div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-4 sm:p-6">
      <div class="flex items-center justify-between">
        ...
        <div class="hidden sm:block text-primary-400">
          <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="52" height="52"><path d="M6 8h15a3 3 0 0 1 3 3v26a3 3 0 0 0-3-3H6V8z"/><path d="M42 8H27a3 3 0 0 0-3 3v26a3 3 0 0 1 3-3h15V8z"/><line x1="24" y1="11" x2="24" y2="37"/></svg>
        </div>
      </div>
    </div>
