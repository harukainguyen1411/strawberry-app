    ...
    <div class="bg-white rounded-lg shadow">
      ...
      <div v-else-if="activeGoals.length === 0" class="p-8 sm:p-12 text-center">
        <div class="mb-4 flex justify-center text-ds-accent">
          <!-- target / goal -->
          <svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="64" height="64"><circle cx="24" cy="24" r="18"/><circle cx="24" cy="24" r="10"/><circle cx="24" cy="24" r="3"/><line x1="24" y1="6" x2="24" y2="12"/><line x1="24" y1="36" x2="24" y2="42"/><line x1="6" y1="24" x2="12" y2="24"/><line x1="36" y1="24" x2="42" y2="24"/></svg>
        </div>
